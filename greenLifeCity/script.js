...
function op1Chapter1() {
  ...
  document.getElementById("btnChapter2").appendChild(btnChapter2);
...
function op1Chapter2() {
  ...
  document.getElementById("btnChapter3").appendChild(btnChapter3);
...
function op1Chapter3() {
  ...
  document.getElementById("btnChapter4").appendChild(btnChapter4);
...
function op1Chapter4() {
  ...
  document.getElementById("btnResultado").appendChild(btnResult);
